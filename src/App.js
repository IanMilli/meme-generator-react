...
class App extends Component {
  ...
  componentDidMount() {
    fetch("https://api.thedogapi.com/v1/images/search?limit=20").then(
      (response) => {
  ...
  render() {
    return (
      <div>
        ...
        <Appbar className="bottomAppBar">
          <a
            style={{ color: "white" }}
            href="https://github.com/IanMilli/meme-generator-react"
          >
            © 2023 Copyright: Manolis Giavasis, Ian Logendra & Ian Millichamp
          </a>
        </Appbar>
      </div>
    );
